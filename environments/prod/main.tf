# ==============================================================================
# Environment: prod
# Large instances, multi_az = true, deletion_protection = false (clean destroy)
...
module "rds" {
  ...
  backup_retention_days = 1      # Minimum — clean destroy after demo
  deletion_protection   = false  # Allow terraform destroy after demo
